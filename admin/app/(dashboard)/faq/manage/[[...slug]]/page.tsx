...
const typeOptions = [
  ...
  { value: "schengen_appointment_checker", label: "Schengen Appointment Checker" },
  ...
  { value: "vietnam_visa_status_checker", label: "Vietnam Visa Status Checker" },
  { value: "visa_eligibility_quiz", label: "Visa Eligibility Quiz" },
  { value: "visa_glossary", label: "Visa Glossary" },
  { value: "visa_glossary_adjustment_of_status", label: "Visa Glossary Adjustment of Status" },
