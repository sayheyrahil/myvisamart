...
const Page = () => {
  ...
  const { deleteItem, changeStatus, editItem, fetchData, showRowDataModal } =
    useCrudOperations(API_URL, {
      delete: ENDPOINTS.testimonials_delete,
      changeStatus: ENDPOINTS.testimonials_change_status,
      get: ENDPOINTS.testimonials_get,
    });
  ...
  const columnsAnt = [
    ...
    {
      title: <div className="flex justify-center">Company Logo</div>,
      dataIndex: "company_logo",
      align: "center",
      render: (text: any, row: any) => (
        <ImageWithPreview
          src={row.company_logo ? row.company_logo : undefined}
          alt={row.company}
        />
      ),
    },
        ...
        <ActionButtons
          ...
          showRowDataModal={() =>
            showRowDataModal([
              ...
              {
                label: "Company Logo",
                value: WEB_URL + row.company_logo,
                isImage: true,
              },
