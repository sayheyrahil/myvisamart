...
export default function NewPortfolioPage() {
  ...
  async function getEditData() {
    if (id) {
      ...
      try {
        let idpass = `?id=${id}`;
        const response = await axiosInstance.get(`${ENDPOINTS.portfolio_edit}${idpass}`)
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      await axiosInstance.post(ENDPOINTS.portfolio_store, payload)
        .then((response) => {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="sm:col-span-2">
                      ...
                      <FormDescription>
                        This will be displayed as the main name of your portfolio item.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button type="submit" disabled={isLoading}>
              {isLoading ? (isEdit ? "Updating..." : "Creating...") : (isEdit ? "Update Portfolio" : "Create Portfolio")}
            </Button>
          </div>
        </form>
      </Form>
