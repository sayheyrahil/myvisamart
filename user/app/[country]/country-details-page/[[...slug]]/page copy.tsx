          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            <div className="md:col-span-3">
                ...
                <div className="flex flex-col sm:flex-row gap-6 mb-6">
                  <div className="flex-1 bg-[#F4F8FB] rounded-xl p-6 flex flex-col items-center shadow">
                    <div className="w-16 h-16 rounded-full bg-brand flex items-center justify-center mb-3">
                      ...
                      >
                        <path
                          d="M12 2a2 2 0 0 1 2 2v2h2.5A1.5 1.5 0 0 1 18 7.5v12A2.5 2.5 0 0 1 15.5 22h-7A2.5 2.5 0 0 1 6 19.5v-12A1.5 1.5 0 0 1 7.5 6H10V4a2 2 0 0 1 2-2Zm0 2H10v2h4V4a2 2 0 0 0-2-2Zm-4 3.5V19.5A1.5 1.5 0 0 0 8.5 21h7a1.5 1.5 0 0 0 1.5-1.5V7.5A.5.5 0 0 0 15.5 7h-7a.5.5 0 0 0-.5.5ZM12 10a1 1 0 1 1 0 2 1 1 0 0 1 0-2Zm0 4a1 1 0 1 1 0 2 1 1 0 0 1 0-2Z"
                          fill="#0A509F"
                        />
                      </svg>
                    </div>
                    ...
                    <div className="text-gray-500 text-sm text-center">
                      Upload or Live Scan. Auto-filled, no manual errors.
                    </div>
                  </div>
                  <div className="flex-1 bg-[#F4F8FB] rounded-xl p-6 flex flex-col items-center shadow">
                    <div className="w-16 h-16 rounded-full bg-brand flex items-center justify-center mb-3">
                    ...
                    <div className="text-gray-500 text-sm text-center">
                      Just 1 steps and we'll process your visa!
                    </div>
                  </div>
                </div>
              ...
              <div className="max-w-6xl mx-auto mt-10">
                ...
                <div className="text-gray-700 text-base mb-6">
                  Atlys will give you a completed application packet with all
                  necessary documents
                </div>
              ...
              <div className="max-w-6xl mx-auto mt-10 space-y-10">
                ...
                <div>
                  <SectionHeading>How to Get a UK Visa on Atlys</SectionHeading>
                  <Image
                ...
                <div>
                  <SectionHeading>Appointment Centers in India</SectionHeading>
                  <Image
                ...
                <div>
                  <SectionHeading>Simplified visas with UK visa</SectionHeading>
                  <Image
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                      ...
                      <div className="flex-1 flex flex-col gap-6">
                        {[
                          ...
                          <div
                            key={idx}
                            className="bg-[#F8FAFC] rounded-xl p-5 shadow flex flex-col"
                          >
                    ...
                    <div className="bg-white rounded-2xl shadow p-5 min-w-[320px] max-w-xs flex-shrink-0">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div className="flex-1">
                          <div className="font-semibold text-[#1A355A]">
                            Adhyayan Gupta
                          </div>
                      ...
                      <div className="text-gray-500 text-sm mb-2">
                        Ut aliqua occaecat cum quibus vero sagittis, saepe no
                        sum sum sed ocsal ad adipisicing sed nostrer ullamco in
                        voluptatum semper porttitor, e porttitor est quod ea
                        fugiat voluptate eu sapiente maximus no sum
                      </div>
                      <a
                ...
                />
                <div>
                  <SectionHeading>Check Serviceability</SectionHeading>
                  <Image
                    src="/extra/Frame1991425232.png"
                    alt="Appointment Centers"
                    width={1200}
                    height={400}
                    className="w-full h-auto rounded-2xl  "
                ...
                <div>
                  <SectionHeading>Our Fulfillment Center</SectionHeading>
                  <Image
                    src="/extra/Frame1991425207.png"
                    alt="Appointment Centers"
                    width={1200}
                    height={400}
                    className="w-full h-auto rounded-2xl  "
                ...
                <div>
                  <SectionHeading>Try our WHAT IF Simulator!</SectionHeading>
                  <Image
                    src="/extra/Frame1991425237.png"
                    alt="Appointment Centers"
                    width={1200}
                    height={400}
                    className="w-full h-auto rounded-2xl  "
                ...
                <div>
                  <SectionHeading>How We Reviewed This Page</SectionHeading>
                  <Image
                    src="/extra/Frame1991425234.png"
                    alt="Appointment Centers"
                    width={1200}
                    height={400}
                    className="w-full h-auto rounded-2xl  "
