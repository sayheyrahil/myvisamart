    ...
    <MasterPage title="Vietnam Visa Status Checker - Track Your E-Visa Application Online">
      <div className="w-full min-h-screen  text-gray-900">
        ...
        <section className="max-w-screen-xl mx-auto px-6 py-12">
          <div
            className="border rounded-2xl p-8 shadow-sm relative"
            style={{ borderColor: "#D6E0EA" }}
          >
            {/* Tab Navigation */}
            <div
              className="flex gap-8 border-b pb-2 mb-8 items-center"
              style={{ borderColor: "#D6E0EA" }}
            >
              <button
        ...
        <div className="flex flex-col justify-center  items-center  px-6 py-12">
          <SectionHeading>Why Use Our Visa Appointment Tracker?</SectionHeading>
          <div className="flex justify-center items-center max-w-3xl mx-auto">
            <SectionDescription>
              Our tool helps you navigate the Schengen visa appointment process
              with ease, saving you time and reducing the stress of visa
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            <div className="rounded-2xl bg-[#F3EDFF] p-6 flex flex-col">
              <Image
                src="/product/Frame1272632083.png"
                alt="Calendar"
                width={50}
                height={50}
              ...
              <div className="text-[#5B5F62] text-base">
                Get up-to-date information on available appointment slots for
                all Schengen countries.
              </div>
            </div>
            <div className="rounded-2xl bg-[#FEF9C3] p-6 flex flex-col">
              <Image
                src="/product/Framess1272632083.png"
                alt="Calendar"
                width={50}
                height={50}
                className="rounded-full  object-cover"
              ...
              <div className="text-[#5B5F62] text-base">
                Find and secure the earliest available appointment dates to plan
                your trip better.
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-[#E0F2FE] p-6 flex flex-col">
              <Image
                src="/product/Frame121272632083.png"
                alt="Calendar"
                width={50}
                height={50}
                className="rounded-full  object-cover"
              ...
              <div className="text-[#5B5F62] text-base">
                Find the nearest visa application centers with detailed address
                information.
              </div>
            </div>
            <div className="rounded-2xl bg-[#F1F5F9] p-6 flex flex-col">
              <Image
                src="/product/Frame1sq272632083.png"
                alt="Calendar"
                width={50}
                height={50}
                className="rounded-full  object-cover"
              ...
              <div className="text-[#5B5F62] text-base">
                Get notified when new appointment slots become available for
        ...
        <div className="max-w-screen-xl mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row gap-10 items-start">
            <div className="flex-1">
              ...
              <SectionDescription>
                Our simple 4-step process helps you find and secure Schengen
                visa appointments quickly and easily.
              </SectionDescription>
            </div>
