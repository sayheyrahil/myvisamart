...
export function buildWelcomeEmail({ email }: WelcomeEmailParams): string {
  ...
  console.log("B :", logoUrl);
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px; background-color: #ffffff;">
      ...
      <!-- Main heading -->
      <h1 style="color: #1F2937; font-size: 32px; font-weight: 700; text-align: center; margin: 30px 0; line-height: 1.2;">
